...
export default function Tracker() {
    ...
    if (editingTask) {
        ...
        // If Manager Mode needs insert, we might need an API for that too, 
        // but let's stick to update first as that was the complaint.
        // Actually, inserting into another team might also be blocked.
        // Let's assume standard insert works for own team, but for Manager Mode...
        // If I am Manager of Team A, adding task to Team B?
        // "New Task" button context?

        // Let's keep direct insert for now. If that fails, I'll update it later.
